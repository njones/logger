...
// ~~ generated on: 2020-02-21 09:06:04.2533586 +0000 UTC m=+0.052914001 ~~
package logger
...
func (b *baseLogger) Print(v ...interface{}) {
	if !hasFlag(b.supress, Info.flag()) {
		b.print(bPrint, v)
	}
}
...
func (b *baseLogger) Warn(v ...interface{}) {
	if !hasFlag(b.supress, Warn.flag()) {
...
func (b *baseLogger) Debug(v ...interface{}) {
	if !hasFlag(b.supress, Debug.flag()) {
...
func (b *baseLogger) Error(v ...interface{}) {
	if !hasFlag(b.supress, Error.flag()) {
...
func (b *baseLogger) Trace(v ...interface{}) {
	if !hasFlag(b.supress, Trace.flag()) {
...
func (b *baseLogger) Fatal(v ...interface{}) {
	if !hasFlag(b.supress, Fatal.flag()) {
...
func (b *baseLogger) Panic(v ...interface{}) {
	if !hasFlag(b.supress, Panic.flag()) {
...
func (b *baseLogger) HTTPln(v ...interface{}) {
	if !hasFlag(b.supress, HTTP.flag()) {
